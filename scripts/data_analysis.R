...
lampyridae_summary_beta <- lampyridae_complete |> # stating new save data frame name and required data set
  group_by(count_type, habitat) |> # stating which columns to include in analysis, and what order to appear on table
